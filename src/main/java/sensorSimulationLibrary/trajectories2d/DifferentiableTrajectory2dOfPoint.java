...
public interface DifferentiableTrajectory2dOfPoint
    extends ContinuousTrajectory2dOfPoint
{
    ////////////////////////////////////////////////////////////////
    // PUBLIC ABSTRACT METHODS
    ////////////////////////////////////////////////////////////////
    public Vector2 velocity();  // velocity measured from origin (vOOF)
    public Vector2 acceleration();  // acceleration measured from origin (aOOF)
    public Vector2 jerk();  // jerk (derivative of acceleration) measured from origin (aOOF)
